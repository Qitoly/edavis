  ...
  return [
    {
      ...
      summary: "В центре города открылся новый многофункциональный центр государственных услуг E-Davis.",
      content:
        "Сегодня состоялось торжественное открытие нового многофункционального центра государственных услуг E-Davis в центре города. Центр оснащен современным оборудованием и предоставляет более 100 различных государственных услуг. Жители города теперь могут получить необходимые услуги в комфортных условиях без очередей.",
      author: "Администрация E-Davis",
    ...
    {
      id: "2",
      title: "Новые электронные услуги на портале E-Davis",
      summary: "На портале государственных услуг E-Davis появились новые электронные сервисы.",
      content:
        "Портал государственных услуг E-Davis расширил список доступных электронных сервисов. Теперь граждане могут подать заявление на получение паспорта, зарегистрировать автомобиль и оформить пособие на ребенка онлайн. Новые сервисы значительно упрощают процесс получения государственных услуг и экономят время граждан.",
    ...
    },
    {
      ...
      summary: "С 1 декабря вступают в силу изменения в процедуре регистрации бизнеса в E-Davis.",
      content:
        "Правительство E-Davis утвердило изменения в процедуре регистрации бизнеса, которые вступают в силу с 1 декабря. Теперь для регистрации юридического лица или индивидуального предпринимателя потребуется меньше документов, а срок рассмотрения заявления сократится до 3 рабочих дней. Эти изменения направлены на поддержку предпринимательства и улучшение бизнес-климата в регионе.",
    ...
    },
    {
      ...
      summary: "Портал государственных услуг E-Davis обновился и стал удобнее для пользователей.",
      content:
        "Портал государственных услуг E-Davis прошел масштабное обновление. Новый дизайн и улучшенная навигация делают использование портала более удобным и интуитивно понятным. Также добавлены новые функции, такие как чат с виртуальным помощником и возможность отслеживания статуса заявлений в режиме реального времени.",
      author: "Департамент цифрового развития",
