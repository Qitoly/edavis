      ...
      <div className="min-h-screen bg-background">
        <header className="border-b bg-background sticky top-0 z-10">
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            <div className="flex items-center">
              <h1 className="font-bold text-2xl">E-Davis Админ-панель</h1>
            </div>
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/admin-panel/goverment">
              <Card className="h-full hover:bg-muted/50 transition-colors cursor-pointer">
                <CardHeader>
                  <Briefcase className="h-8 w-8 mb-2 text-primary" />
                  <CardTitle>Состав</CardTitle>
                  <CardDescription>Управление составом правительства</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Создание и редактиврования состава правительства
                  </p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/admin-panel/treasury">
              <Card className="h-full hover:bg-muted/50 transition-colors cursor-pointer">
                <CardHeader>
                  <Settings className="h-8 w-8 mb-2 text-primary" />
                  <CardTitle>Казна</CardTitle>
                  <CardDescription>Состояние Казны</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Управление состоянием казны, добавление и редактирование записей
                  </p>
                </CardContent>
              </Card>
            </Link>
